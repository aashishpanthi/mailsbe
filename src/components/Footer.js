    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.widget0Div}>
        <div className={styles.weAreHereToHelpYouSuceed}>
          We are here to help you suceed in your digital journey by helping you
          in your everyday journey. We help you to find out if the receiver has
          read the email or not.
        </div>
